...
counts_file <- "GULN_bird_counts.csv" # This is the combination of (sans VICK) GULN 2010-2022 data with VICK 2010-2023 data
park_lists_file <- "Park_lists_2017.csv"
veg_file <- "GULN_AllParks_BBird_Veg_061522.csv"
conditions_file <- "GULN_AllParks_BBird_SiteConditions.csv"
...
incomplete_records <- df_initialdat %>%
  dplyr::select(unit_code, location_name, event_date, species_code, distance_bin_id, count, data_status) %>%
  dplyr::filter(!complete.cases(.)) %>%
  dplyr::arrange(location_name, event_date, species_code)
