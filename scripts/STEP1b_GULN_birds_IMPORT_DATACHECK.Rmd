...
dom_hab_50 <- df_buffer_info %>%
  ...
  dplyr::mutate(
    hab_type_50 = ifelse(dom_hab_prop_50 >= 60, dom_hab_50, "mixed"))
...
dom_hab_100 <- df_buffer_info %>%
  ...
  dplyr::mutate(
    hab_type_100 = ifelse(dom_hab_prop_100 >= 60, dom_hab_100, "mixed"))
...
dom_hab <- df_buffer_info %>%
  ...
  dplyr::mutate(
    hab_type_200 = ifelse(dom_hab_prop_200 >= 60, dom_hab_200, "mixed")
  ) %>%
