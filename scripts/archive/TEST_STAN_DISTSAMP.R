...
covs_st <- dat_Nmix %>%
  dplyr::select(yr, yr_sc, yr_f, location_name, julian_prop_c, hrs_since_rise_c, weather_wind_comb,  hab_type_100_comb, hab_type_200_comb, prop_understory_cover_50, prop_understory_cover_100, prop_understory_cover_200, understory_cover_sd_50, understory_cover_sd_100, understory_cover_sd_200)
...
### YEARMOD ----
m_tmb <- stan_distsamp( # detection covariates first
  ~hrs_since_rise_c + julian_prop_c + weather_wind_comb + hab_type_200_comb
  ~yr_f  + (1|location_name) + hab_type_200_comb + prop_understory_cover_200 +  I(prop_understory_cover_200^2),
  data = umf, 
  keyfun = "halfnorm",
  output = "density",
  unitsOut = "ha",
