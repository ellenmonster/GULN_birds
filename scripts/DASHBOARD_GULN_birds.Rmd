...
write_csv(df_locs, here::here("PARK_HABITATS.csv"))
...
renderUI({
  ...
  checkboxGroupInput("sel_species_parks",
                     ...
                     selected = "PAAL" #switch(is.null(input$sel_species_parks)+1, input$sel_species_parks, FuncParkChoices(input$sel_common, input$sel_species))  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                     )
  })
